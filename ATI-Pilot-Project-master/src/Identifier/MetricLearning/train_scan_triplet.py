...
from utilities.utils_scan_trip import Utilities
from utilities.utils import Augment
...
def trainFold(args):
    ...
    if args.augment:
        print(f'HALF CHANCE Resize 85%-100%, THE REST REMAIN THE SAME')
        transform = transforms.Compose([
            Augment(2, show_to_check=0),
            transforms.ToTensor(),
            # transforms.c( mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]),
        ])
    else:
        print(f'NO')
        transform = None
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_path', type=str, default="/home/io18230/Desktop/train_tem",
    ...
    # Dataset settings
    parser.add_argument('--dataset', type=str, default='RGBDCows2020',  ########jing RGBDCows2020  scan_data
    ...
    parser.add_argument('--triplet_selection', type=str, default='PositiveNegative',
                        help='Which triplet selection method to use: [PositiveNegative, HardestNegative, RandomNegative,\
						SemihardNegative, AllTriplets]')
    parser.add_argument('--loss_function', type=str, default='OnlineReciprocalTripletLoss',
    ...
    parser.add_argument('--trainedWeight', type=str, default='defultp') #  /home/io18230/Desktop/May/current050_model_state.pkl
