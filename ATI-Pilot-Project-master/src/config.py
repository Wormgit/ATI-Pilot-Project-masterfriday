...
if os.path.exists("/home/io18230/Desktop"):	# Home windows machine
	...
	cfg.DAT.CSV_PATH = f"/work/{cfg.GEN.BLUE_USERNAME}/Projects/ATI-workspace/database/csv"
else: #Jing's GPU computer
...
if os.path.exists("/home/io18230/Desktop"):	# Home windows machine
	...
	cfg.FSM.WORKSPACE = f"/work/{cfg.GEN.BLUE_USERNAME}/Projects/ATI-workspace/videos"
else: #Jing's GPU computer
...
if os.path.exists("/home/io18230/Desktop"): # Home Windows machine
	...
	cfg.DATASET.RGBDCOWS2020_LOC = "/home/io18230/Desktop/next/Farm1_date_remove_single"
